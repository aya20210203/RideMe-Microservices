...
public class LoggingAspect {
    ...
    @Pointcut(value = "execution(* com.RideMe.Admin.Repository..*(..))")
    public void forRepoLog(){}
    @Pointcut(value = "execution(* com.RideMe.Admin.Service..*(..))")
    public void forServiceLog(){}
    @Pointcut(value = "execution(* com.RideMe.Admin.Controller..*(..))")
